...
func (g *generator) generateClientMethod(buf *strings.Builder, serviceName string, method *protogen.Method) {
	...
	case isClientStreaming && !isServerStreaming:
		...
		buf.WriteString("\tdefer close(errChan)\n")
	...
	case !isClientStreaming && isServerStreaming:
		...
		buf.WriteString("\t\t\tcase <-errChan:\n")
		buf.WriteString("\t\t\t\treturn\n")
		buf.WriteString("\t\t\tcase msg, ok := <-outChan:\n")
		buf.WriteString("\t\t\t\tif !ok {\n")
		buf.WriteString("\t\t\t\t\treturn\n")
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString("\t\t\t\t// If we already have a conversion error, continue draining outChan\n")
		buf.WriteString("\t\t\t\t// to prevent blocking c.client.ServerStream\n")
		buf.WriteString("\t\t\t\tif convErr != nil {\n")
		buf.WriteString("\t\t\t\t\tcontinue\n")
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString(fmt.Sprintf("\t\t\t\ttyped, ok := msg.(*%s)\n", outputType))
		buf.WriteString("\t\t\t\tif !ok {\n")
		buf.WriteString(fmt.Sprintf("\t\t\t\t\tconvErr = fmt.Errorf(\"type assertion failed: expected *%s, got %%T\", msg)\n", outputType))
		buf.WriteString("\t\t\t\t\tcontinue\n")
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString("\t\t\t\tselect {\n")
		buf.WriteString("\t\t\t\tcase <-ctx.Done():\n")
		...
		buf.WriteString("\t\t\t\tcase <-errChan:\n")
		buf.WriteString("\t\t\t\t\treturn\n")
		buf.WriteString("\t\t\t\tcase out <- typed:\n")
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString("\t\t\t}\n")
		buf.WriteString("\t\t}\n")
		buf.WriteString("\t}()\n")
		buf.WriteString("\terr = c.client.ServerStream(ctx, *u, in, factory, outChan)\n")
		buf.WriteString("\tif convErr != nil {\n")
		buf.WriteString("\t\treturn convErr\n")
		buf.WriteString("\t}\n")
		buf.WriteString("\treturn err\n")
		buf.WriteString("}\n\n")
	...
	case isClientStreaming && isServerStreaming:
		...
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString("\t\t\t\t// If we already have a conversion error, continue draining outChan\n")
		buf.WriteString("\t\t\t\t// to prevent blocking c.client.BidirectionalStream\n")
		buf.WriteString("\t\t\t\tif convErr != nil {\n")
		buf.WriteString("\t\t\t\t\tcontinue\n")
		buf.WriteString("\t\t\t\t}\n")
		buf.WriteString(fmt.Sprintf("\t\t\t\ttyped, ok := msg.(*%s)\n", outputType))
		...
		buf.WriteString("\t\t}\n")
		buf.WriteString("\t}()\n")
		buf.WriteString("\terr = c.client.BidirectionalStream(ctx, *u, inChan, factory, outChan)\n")
		buf.WriteString("\tif convErr != nil {\n")
		buf.WriteString("\t\treturn convErr\n")
		buf.WriteString("\t}\n")
		buf.WriteString("\treturn err\n")
